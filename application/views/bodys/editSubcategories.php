<section class="dashboard-container">
    <div class="dashboard-body">
        <div class="body-title">
            <h2>Modifica tu Subcategoría</h2>
            <p>Escribe el nombre de la subcategoría</p>
        </div>
        <div class="body-content">
            <form id="formEditSubcategory" action="">
                <hr class="divider">
                <div class="info-divider margin-top margin-bot">
                    <h4>Crear subcategoría</h4>
                </div>
                <div class="form-control">
                    <label for="categoryName">Nombre de Subcategoría:</label>
